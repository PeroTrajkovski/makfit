...
export default function SubscriptionView({ profile, setView, onSubscribe }: Props) {
  ...
  const trialEndDate = formatSubscriptionDate(profile?.subscriptionTrialEndsAt);
  ...
  const [selectedPlanId, setSelectedPlanId] = useState<SubscriptionPlan['id']>('trial-7-days');
          ...
          <div className="relative">
            ...
            {isPremium ? (
              <>
                ...
                <h3 className="text-2xl font-bold mb-1">Makfit Premium</h3>
                ...
                <div className="mt-4 bg-black/30 border border-amber-500/25 rounded-2xl p-3">
                  ...
                  <div className="space-y-1.5 text-xs">
                    ...
                    <div className="flex items-center justify-between gap-3">
                      <span className="text-zinc-500">Активна вкупно</span>
                      <span className="text-zinc-100 font-semibold text-right">
                        {activeSubscriptionDays != null ? `${activeSubscriptionDays} дена` : '-'}
                      </span>
                    </div>
                    {trialEndDate && (
                      <div className="flex items-center justify-between gap-3">
                        <span className="text-zinc-500">Крај на пробен период</span>
                        <span className="text-zinc-100 font-semibold text-right">{trialEndDate}</span>
                      </div>
                    )}
                    {nextChargeDate && (
                      <div className="flex items-center justify-between gap-3">
                        <span className="text-zinc-500">Следна наплата</span>
                        <span className="text-zinc-100 font-semibold text-right">{nextChargeDate}</span>
                      </div>
                    )}
                  </div>
                </div>
              ...
              <>
                <h3 className="text-2xl font-bold mb-2">Makfit Premium</h3>
